...
<div class="content">
    <div class="company_div_sp">
        <div class="company_column">
            <div class="company_left_sp">会社名 / Company</div>
            <div class="company_right">株式会社CROWTECH / CROWTECH co;ltd</div>
        </div>
        <div class="company_column">
            <div class="company_left_sp">住所 / Address</div>
            <div class="company_right">
                〒540-0038<br>
                大阪府大阪市中央区内淡路町2-4-10<br>
                グランダム内淡路201<br>
                Grandum-Uchiawaji201,<br>
                Uchiawajimachi,<br>
                Osaka Shi Chuo ku, Osaka Fu
            </div>
        </div>
        <div class="company_column">
            <div class="company_left_sp">TEL</div>
            <div class="company_right">06-6484-6013 / +81-6-6484-6013</div>
        </div>
        <div class="company_column">
            <div class="company_left_sp">FAX</div>
            <div class="company_right">06-0484-6014 / +81-6-0484-6014</div>
        </div>
        <div class="company_column">
            <div class="company_left_sp">MAIL</div>
            <div class="company_right">info@crowtech.jp</div>
        </div>
        <div class="company_column">
            <div class="company_left_sp">取引銀行 / Bank</div>
            <div class="company_right">GMOあおぞらネット銀行 /<br>GMOaozoranet bank</div>
        </div>
        <div class="company_column">
            <div class="company_left_sp">設立日 / Founding Date</div>
            <div class="company_right">2021年12月 / Desenber/2021</div>
        </div>
    </div>
</div>
