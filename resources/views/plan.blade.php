...
<div class="content">
    <div class="work_column" id="work_column1_sp">Promorion Planning</div>
    <div class="work_column" id="work_column2_sp">Business Planning</div>
    <div class="work_text">
    多くのパートナー企業と仕事を一緒に行っています。<br>
    その結果我々の周辺には多くのエキスパートが揃っています。<br>
    宣伝やマーケティング、貿易や販売、飲食店の経営やファッション分野など。<br>
    ...
    We are looking for more experience and knowledge.<br>
    I would like to take on a new challenge with your company.<br>
    Of course, our members understand<br>
    your company's vision and support planning<br>
    and marketing that you can feel secure about.
    </div>
</div>

<div class="bg_div plan_bg_sp"></div>
